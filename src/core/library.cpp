...
// library manager
std::unordered_map<std::string, std::shared_ptr<RF::lib>> RF::library_m::libraries_;

std::shared_ptr<RF::lib> RF::library_m::load_library(const std::string_view libname)
{
	...
	auto lib_ptr = std::make_shared<RF::lib>(libname);
...
// lib
RF::lib::lib(const std::string_view libname)
{
